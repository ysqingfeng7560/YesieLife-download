...
const softwareData = [
  ...
  { id: "12", name: "DiskGenius", keywords: ["磁盘","修复","恢复"],    
    ...
    desc: "破解版 6.0.0.1631", size: "解压密码 yesong | 蓝奏云 | 29.6 MB" },
  ...
  { id: "15", name: "ffmpeg", keywords: ["程序","音频","视频","破解"],    
    icon: "pic/app8.png", 
    url: "https://wwvo.lanzouo.com/b0065nz6wj", 
    desc: "正式版 全版本", size: "解压密码 0000 | 蓝奏云 | 51.7 MB"" },
